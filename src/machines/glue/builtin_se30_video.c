...
// declrom builder (this replaced the 220-line byte-banged image inherited
// from se30.c); the two 68K code blocks are spliced verbatim and carry the
// same bytes the byte-banged image did.
...
// mechanism that was missing.  The mechanism exists; the workaround is
