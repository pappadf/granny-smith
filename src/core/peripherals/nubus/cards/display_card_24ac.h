...
// (DISPLAY_CARD_24AC_VRAM_VISIBLE .. the engine alias) are served by the operand
// region's passive fall-through, so the whole 4 MB bank stays addressable.
#define DISPLAY_CARD_24AC_VRAM_VISIBLE    0x00380000u // host-mapped + aliased passive bank
#define DISPLAY_CARD_24AC_FB_ALIAS_OFFSET 0x00900000u // 24-bit-mode framebuffer mirror
...
#define DISPLAY_CARD_24AC_STATUS_OFFSET  0x00D00402u // STATUS read (byte)
#define DISPLAY_CARD_24AC_VIDCTL_OFFSET  0x00D00403u // VIDCTL read/write (byte)
#define DISPLAY_CARD_24AC_CONFIG_OFFSET  0x00D40402u // CONFIG read (byte, engine)
#define DISPLAY_CARD_24AC_CONTROL_OFFSET 0x00D40403u // CONTROL write (byte, engine)
...
#define DISPLAY_CARD_24AC_RAMDAC_CMD 0x00C80006u // RAMDAC command (#$E3 init) — accept-log
#define DISPLAY_CARD_24AC_CLUT0_DATA 0x00C8000Au // init/clear CLUT data
#define DISPLAY_CARD_24AC_CLUT0_ADDR 0x00C8000Eu // init/clear CLUT index
#define DISPLAY_CARD_24AC_CLUT_CTL   0x00C80016u // CLUT end-of-load strobe — accept-log
#define DISPLAY_CARD_24AC_CLUT_DATA  0x00C8001Au // runtime CLUT data
#define DISPLAY_CARD_24AC_CLUT_ADDR  0x00C8001Eu // runtime CLUT index
...
#define DISPLAY_CARD_24AC_MODE_REG  0x00D80001u // bits7-5 depth, bits4-0 timing (= CRTC[9])
#define DISPLAY_CARD_24AC_DEPTH_REG 0x00D80005u // low nibble = depth/clock field
#define DISPLAY_CARD_24AC_SENSE_CLK 0x00D8000Du // sense read (bits7-5, inverted) + PLL bit-bang
#define DISPLAY_CARD_24AC_CRTC_LO   0x00D80015u // CRTC[8] (lowest timing-file address)
#define DISPLAY_CARD_24AC_CRTC_HI   0x00D80035u // CRTC[0] (highest); whole file is write-only

// Slot-space pages we register device callbacks over (4 KB each).
#define DISPLAY_CARD_24AC_CLUT_PAGE 0x00C80000u // CLUT / RAMDAC block
#define DISPLAY_CARD_24AC_D00_PAGE  0x00D00000u // STATUS + VIDCTL
