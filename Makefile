...
LDFLAGS := $(MODE_CFLAGS) \
           ...
           -s EXPORTED_FUNCTIONS="['_main','_shell_init','_shell_interrupt','_background_checkpoint_from_js','_get_cmd_buffer','_get_cmd_pending_ptr','_get_cmd_done_ptr','_get_cmd_result_ptr','_get_prompt_buffer','_get_is_running_ptr','_get_cmd_json_buffer','_get_completion_buffer','_get_gs_eval_buffer','_get_gs_path_buffer','_get_gs_args_buffer','_get_gs_pending_ptr','_get_gs_done_ptr','_get_gs_result_ptr','_get_shell_ready_ptr']" \
           -s STACK_SIZE=5MB \
