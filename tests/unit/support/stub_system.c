...
void scheduler_new_cpu_event(scheduler_t *sched, event_callback_t callback, void *source, uint64_t data, uint64_t cpu_cycles, uint64_t ns_delay) {
    (void)sched; (void)callback; (void)source; (void)data; (void)cpu_cycles; (void)ns_delay;
}

void scheduler_new_event_type(scheduler_t *sched, const char *module, void *source, const char *name, event_callback_t callback) {
    (void)sched; (void)module; (void)source; (void)name; (void)callback;
}

void remove_event(scheduler_t *sched, event_callback_t callback, void *source) {
    (void)sched; (void)callback; (void)source;
}

void remove_event_by_data(scheduler_t *sched, event_callback_t callback, void *source, uint64_t data) {
    (void)sched; (void)callback; (void)source; (void)data;
}

// Mouse stub for automation command
void system_mouse_update(bool button_down, int dx, int dy) {
    (void)button_down; (void)dx; (void)dy;
}
