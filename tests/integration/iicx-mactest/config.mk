# STAYS ON THE IIcx. This was once re-hosted to the IIci (the media is
...
# real defect, guarded by suite-iici's iici-mactest-diag milestone row; it is
# not something a golden recapture may paper over. The IIcx runs the full flow,
