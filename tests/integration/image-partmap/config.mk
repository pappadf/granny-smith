...
# Exercises the image command against an APM-formatted A/UX hard disk
# image.  Verifies the command runs to completion without triggering an
# assertion or non-zero exit.
