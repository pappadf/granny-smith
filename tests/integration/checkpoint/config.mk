...
#
# Merged from the former checkpoint + checkpoint2 pair: same ROM, media,
# golden and flow — they differed only in runner plumbing. This keeps checkpoint2's static
...
#
# Also keeps the Plus x 6.0.8-HD matrix cell lit (checkpoint stays on 6.0.8
# deliberately) and exercises save/load under a System 6 guest.
