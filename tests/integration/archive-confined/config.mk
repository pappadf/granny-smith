...
# (09-storage F-13).  A StuffIt 5 archive whose one file is named
# "../escape" -- a legal Mac name, '/' being an ordinary character on HFS --
# must extract as "..:escape" inside the output directory, not as "escape"
# beside it.
