# Integration test: TNT ROM boot ladder
#
...
# registers); the run parks at the video wall (no Control model
# yet — ScrnBase stays 0).

TEST_NAME := TNT ROM ladder
TEST_DESC := Boots the TNT ROM and asserts the ladder markers up to the committed high-water rung
