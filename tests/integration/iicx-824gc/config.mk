...
#
# It does NOT boot the OS through the decl-ROM video driver's RISC-driven
# display hardware bring-up, which still hangs and needs the GC's Am29000-side
# video hardware modelled — see local/gs-docs/8-24GC/decl-rom-disasm/ and the
# investigation notes.  No SCSI HD image is needed.
