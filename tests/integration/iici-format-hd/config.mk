# RE-HOSTED IIcx -> IIci: this is the NCR 5380 pseudo-DMA regression guard,
...
# and the coordinates were re-derived from measured frames on this host.
#
...
# 8 MB: a IIci does not complete POST below that, so this is the floor rather
# than a choice.
