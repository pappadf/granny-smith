...
# seated and one card-specific assert. One dual-card boot covers both for
# half the cost — and additionally tests the multi-card path under a real
...
# Media is 7.6 (the dual-card contract is version-incidental, so the row
# buys the otherwise-dark Q700 x 7.6 cell). Copied into WORK_DIR because
