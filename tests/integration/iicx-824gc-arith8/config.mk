...
#
# Covers the QuickDraw arithmetic transfer modes (blend, addPin, addOver,
# subPin, transparent, adMax, subOver, adMin — component math on the CLUT,
# result through the card-side Color2Index) and op $74 opRGBPat
