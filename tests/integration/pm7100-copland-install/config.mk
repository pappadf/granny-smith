...
#
# Phase 3 of the Copland install.  It starts from the formatted, empty volume
# `pm7100-copland-format` publishes, so it never pays for the boot-and-format
# again:
#
...
#
# MEDIA: the Copland media and the volume pm7100-copland-format publishes are
...
# 24 MB: inside Copland's 16-32 MB window.
